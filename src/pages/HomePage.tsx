    ...
    <DefaultLayout>
      ...
      >
        <Box className="uppercase font-semibold text-3xl w-[40%] border-solid border-3 border-gray-500 rounded-2xl flex-row justify-between px-6 py-4">
          ...
          <button
            className="cursor-pointer uppercase font-semibold text-2xl border-solid border-3 hover:border-gray-300 transition-all duration-300 border-gray-500 rounded-2xl py-2 px-6"
